    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-lg-6 product-detail" style="margin-top: 3%;">
                <img src="https://down-id.img.susercontent.com/file/id-11134207-7qul8-li30fe2z75gqce" alt="Jam Tangan Wanita Rubber" class="img-fluid">
                <div class="deskripsi" style="margin-left: 40%; margin-top: -30%;" >
                    <h4 style="color: white; ">New Arrival Jam Tangan Wanita FoxxiL 7198 Diagonal 34mm Tanggal Aktif Tali Rubber Include Box Batrai</h4>
                   ...
                   <!-- Formulir untuk mengarahkan pengguna ke halaman checkout -->
