...
<body>
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-lg-6 product-detail" style="margin-top: 3%;">
                <img src="https://down-id.img.susercontent.com/file/a0b4f7843e56ce46b926f3fd0680239e" alt="Jam Tangan Wanita Rubber" class="img-fluid">
                <div class="deskripsi" style="margin-left: 40%; margin-top: -30%;" >
                    <div class="product-description" style="color: white;">BIDEN Jam Tangan Pria Bisnis Santai Mode Anti Air Kuarsa Tali Stainless Steel Jam Tangan Cowok Original</div>
                    <div class="product-description">SPESIFIKASI PRODUK :
                        Diameter Panggil: 40mm        
                        Panjang Band: 235cm      
                        Ketebalan case: 8.5mm      
                        Lebar Band: 20mm
                    <div class="product-price">Rp 289.000</div>
                    <div class="rating">
                    ...
                    <form action="{{ route('cart.add') }}" method="POST">
                        @csrf
                        <input type="hidden" name="name" value="Jam Tangan Pria Bisnis Santai Mode Anti Air Kuarsa Tali Stainless Steel">
                        <input type="hidden" name="price" value="289000">
                        <input type="hidden" name="quantity" id="hidden-quantity" value="1">
                        <button class="btn btn-light mt-3" type="submit">Masukkan ke Keranjang</button>
                    </form>                    
    ...
    <script>
        ...
        document.getElementById('addBtn').addEventListener('click', function() {
            ...
            let product = {
                name: "Jam Tangan Pria Bisnis Santai Mode Anti Air Kuarsa Tali Stainless Steel",
                price: 289000,
